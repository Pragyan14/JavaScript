...
console.log(arr.indexOf(3));        // return index of of passed element, if not exist return -1
console.log(arr.indexOf(3));        // return index of of passed element, if not exist return -1
...
console.log(arr)
console.log("B:  " + arr.splice(2,4))   // return element in range including end range and also delete that elements from orginal array
console.log(arr)